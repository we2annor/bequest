    ...
    var findByPostCode = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, addressBook_1.findAddress.get("find/" + postCode + "?api-key=" + addressBook_1.API_KEY)];
                case 1:
                    response = _a.sent();
    ...
    var findByPostCodeAndHouseNumber = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, addressBook_1.findAddress.get("find/" + postCode + "/" + houseNumber + "?api-key=" + addressBook_1.API_KEY)];
                case 1:
                    response = _a.sent();
            ...
            react_1["default"].createElement("div", { className: 'find-address__form-container' },
                react_1["default"].createElement("form", { className: 'find-address__form', "aria-label": 'find-address-form', title: 'find-address-form' },
                    react_1["default"].createElement("div", { className: 'find-address__form--input-field' },
                        react_1["default"].createElement("label", { htmlFor: 'postCode', "aria-label": 'postCode', className: 'find-label' },
                            "Find Address by post code or",
                            " ",
                            react_1["default"].createElement("span", { onClick: function (e) { return onAddManuallyButtonClicked(e); }, "aria-label": 'add-address-manually', title: 'add-address-manually', role: 'button' }, "add address manually")),
                        react_1["default"].createElement("input", { className: "postcodd " + error, type: 'text', id: 'postCode', name: 'postCode', "aria-label": 'postCode', "aria-required": true, placeholder: 'Find address by post code', "aria-placeholder": 'Find address by post code', autoComplete: 'off', onChange: function (e) { return setPostCode(e.target.value); }, "aria-describedby": 'postCode_error' }),
                        react_1["default"].createElement("input", { className: 'house-number', type: 'text', id: 'houseNumber', "aria-label": 'houseNumber', title: 'houseNumber', "aria-required": true, placeholder: 'house number', "aria-placeholder": 'house number', onChange: function (e) { return setHouseNumber(parseInt(e.target.value)); } }),
                    ...
                    postCode.length > KeyedCharacters && (react_1["default"].createElement(AddressSuggestions_1["default"], { suggestionResults: addressSuggestions, getAddress: getAddress }))))),
...
exports["default"] = react_redux_1.connect(null, { addContact: actions_1.addContact })(AddContact);
